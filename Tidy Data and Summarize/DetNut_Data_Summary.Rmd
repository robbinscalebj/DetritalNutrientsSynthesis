...
library(datawizard)
library(here)
devtools::install_github('dgrechka/RFc', build_vignettes = FALSE)
devtools::install_github('guillembagaria/ggbiome', build_vignettes = FALSE)
...
det <- read_csv(here("Tidy Data and Summarize/DetNutSynth_Database_30Aug2022.csv"))
...
```{r histogram breakdown rates by litte type}
...
lat_longs|>write_csv("C:/Users/caleb/Desktop/lat_longs2.csv")


test_coords <- lat_longs|>ungroup()|>slice_head(n = 2)|>select(Lat_Long, First_Author)|>
...
library(geodata)
derp<-gd_get_biome(data = test_coords, si_lat = "Lat", si_long = "Long")

#the values from worldclim_tile look ridiculous
worldclim_tile(lat = 40, lon = -90, path = "C:/Users/caleb/Desktop/test/", var = "bio")

library(raster)
BClim2 <- getData(name="worldclim", var="bio", res=0.5, lat=40, lon=-90, path="C:/Users/caleb/Desktop/test/") #doesn't work
```