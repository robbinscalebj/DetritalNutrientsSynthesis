...
#N.gam <- gam(data = det3, N_mass_norm ~ te(Mass_per_loss, initial_N) + s(series_index, bs = "re"), method = "REML")

N.gam <- gam(data = det3, N_mass_norm ~ te(Mass_per_loss, initial_N, by = Lotic_Lentic) + s(series_index, bs = "re"), method = "REML")
