...
DetNut3<-DetNut2%>%
  ...
  mutate(CN_molar = case_when(is.na(CN_molar) ~ ((C_per/N_per)*(14/12)),
                              TRUE ~ CN_molar),
         CP_molar = case_when(is.na(CP_molar) ~ ((C_per/P_per)*(31/12)),
                              TRUE ~ CP_molar),
         NP_molar = case_when(is.na(NP_molar) ~ ((N_per/P_per)*(31/14)),
                              TRUE ~ NP_molar))
