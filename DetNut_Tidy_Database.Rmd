...
This markdown shows the process used to clean and compile proofed .txt files into the final Detrital Nutrients dataset (.csv). This markdown was created using R version 4.1.2 (2021-11-01).
