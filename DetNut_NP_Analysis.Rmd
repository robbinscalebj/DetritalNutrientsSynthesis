...
EDIT: INFERENCE IS BASICALLY STUCK ON JUST USING PVALUES AFTER COMPARING MODELS FOR RANDOM EFFECTS STRUCTURE - CAN'T USE aic WHEN SAMPLE SIZES ARE MISMATCHED
...
Now we can build up models from our base model to explore how the following factors influence N mass trends:
Initial N
Initial Lignin
Ergosterol
Temp
...
AIC(base_loc_mod, N_Ni2, N_Ni5) #however there is a slight reduction in AIC compared to Base model with Ni2, vs Ni5. 


base_Ni_mod <- N_base_loc2 #set best model to easier name to remember for later comparisons
